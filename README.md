[![Run App MaxxSeminario](https://github.com/maxxseminario/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/maxxseminario/GithubActions/actions/workflows/run-app.yaml)
# Github Actions Lab
